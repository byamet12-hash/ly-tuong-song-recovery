...
Hãy sử dụng Memory để hiểu bối cảnh của người dùng.
Nếu Memory liên quan đến câu hỏi, hãy chủ động liên hệ nó
với câu hỏi thay vì chỉ yêu cầu người dùng nhắc lại thông tin.
{memory_text}
